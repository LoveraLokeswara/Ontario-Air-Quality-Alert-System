...
-   Hourly data from 2019/06/22 to 2025/12/31 **(total 56,306 rows)**
...
-   Missingness handling:
    ...
    -  $PM_{2.5}$ missingness was forward filled up to 2 hours, else the remaining rows were dropped
...
- trainable parameters: 216,642 parameters

\begin{alertblock}{Chosen config}
$L=24$, hidden width $=128$, learning rate $=0.00005$
\end{alertblock}
...
|--------|--------|--------|
| LASSO  | 6.7530 | 4.1626 |
| N-HiTS | 6.7594 | 4.1508 |

: Model RMSE Comparison {#tbl-model-rmse}

- The LASSO and N-HiTS models produce very similar RMSE and MAE values.
- The N-HiTS model's ability to capture non-linearities and multi-scale patterns does not translate into a significant improvement in forecasting accuracy for this dataset
